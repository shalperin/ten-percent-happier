...
import kotlinx.android.synthetic.main.meditation_fragment_global_stats.*
...
class GlobalStatsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.meditation_fragment_global_stats, container, false)
    }
